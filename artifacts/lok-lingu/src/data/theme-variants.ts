...
export const THEME_VARIANTS: ThemeVariant[] = [
  ...
  // ── Legendary variants ─────────────────────────────────────
  {
    ...
    name: 'VOID EMBER',
    label: 'Void Ember',
    desc: 'Smoldering core. The void caught fire and refuses to go out.',
    tier: 'legendary',
    changes: {
      bg: '#0a0200',
      wordColor: '#FF4500',
      wordGlow: '0 0 22px #ff4500, 0 0 50px #8b1a00',
      subColor: 'rgba(255,69,0,0.5)',
      border: '#ff4500',
      font: "'Barlow Condensed', sans-serif",
    },
  },
  {
    id: 'matrix-phantom-chrome',
    themeId: 'theme-matrix',
    name: 'PHANTOM CHROME',
    label: 'Phantom Chrome',
    desc: 'Ghost in the machine. Silver-white code with zero noise.',
    tier: 'legendary',
    changes: {
      bg: '#030303',
      wordColor: '#e0e0e0',
      wordGlow: '0 0 16px #ffffff, 0 0 40px #888888',
      subColor: 'rgba(224,224,224,0.5)',
      border: '#888888',
      font: "'Space Mono', monospace",
    },
  },
  {
    id: 'cosmos-aurora-deep',
    themeId: 'theme-cosmos',
    name: 'AURORA DEEP',
    label: 'Aurora Deep',
    desc: 'Below the northern lights, in still water. Infinite reflection.',
    tier: 'legendary',
    changes: {
      bg: '#030a12',
      wordColor: '#88ffcc',
      wordGlow: '0 0 24px #00ffaa, 0 0 60px #0033aa',
      subColor: 'rgba(136,255,204,0.5)',
      border: '#00ffaa',
      font: "'Outfit', sans-serif",
    },
  },
  {
    id: 'crimson-blood-crystal',
    themeId: 'theme-crimson',
    name: 'BLOOD CRYSTAL',
    label: 'Blood Crystal',
    desc: 'Faceted and deep red. Light bends wrong inside it.',
    tier: 'legendary',
    changes: {
      bg: '#0d0003',
      wordColor: '#FF1040',
      wordGlow: '0 0 20px #FF1040, 0 0 48px #8b0020',
      subColor: 'rgba(255,16,64,0.5)',
      border: '#FF1040',
      font: "'Cinzel', serif",
    },
  },
