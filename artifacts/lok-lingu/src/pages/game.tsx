            ...
            <motion.h1
              ...
              animate={
                prefersReducedMotion
                  ? {}
                  : feedback === 'hit'
                    ? { scale: [1, 1.12, 1], filter: ['brightness(1)', 'brightness(1.7)', 'brightness(1)'], x: 0, y: 0, rotate: 0, skewX: 0 }
                    : feedback === 'miss'
                      ? MISS_VARIANTS[missVariantRef.current]
                      : { scale: 1, x: 0, y: 0, rotate: 0, skewX: 0, filter: 'brightness(1)' }
              }
              transition={
                feedback === 'miss'
